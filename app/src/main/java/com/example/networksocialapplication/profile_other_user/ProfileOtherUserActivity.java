package com.example.networksocialapplication.profile_other_user;
        ...
        mUserDatabase.child(mReceiverUserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mTxtDes.setText(des);
                    Glide.with(getApplicationContext()).load(avatar).error(R.drawable.ic_load_image_erroe).into(mAvatar);
