...
public class ReflectProgressedFragment extends Fragment implements StatusReflect {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_reflect_progressed, container, false);
    ...
    private void initRecyclerview(View view) {
        ...
        mRecyclerView = view.findViewById(R.id.recycler_view_list_reflect_progressed);
        ...
        mReflectRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot item : dataSnapshot.getChildren()) {
                    ...
                    if (reflect.getStatus().equals(PROGRESSED)) {
