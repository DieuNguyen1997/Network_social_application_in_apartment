package com.example.networksocialapplication.user.list_overate_status;
...
public class OveratStatusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_overat_status, container, false);
        mRecyclerView = view.findViewById(R.id.recycler_view_list_friend_status);
