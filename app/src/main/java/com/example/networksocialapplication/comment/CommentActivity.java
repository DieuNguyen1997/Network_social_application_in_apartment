package com.example.networksocialapplication.comment;
...
import com.example.networksocialapplication.activities.AddPostActivity;
        ...
        mUserRef.child(mCurrentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    String avatar = dataSnapshot.child("avatar").toString();
